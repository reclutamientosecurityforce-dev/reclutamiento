...
exports.getRecruitmentSummary = getRecruitmentSummary;
exports.getRecentRecruitmentActivity = getRecentRecruitmentActivity;
const db_1 = __importDefault(require("../../../../db"));
/**
 * GET /api/recruitment/summary
 * Métricas agregadas y embudo de selección en tiempo real.
 */
async function getRecruitmentSummary(req, res) {
    try {
      ...
      `, [companyId]);
        ...
        const pipelineResult = await db_1.default.query(`SELECT current_stage AS stage, COUNT(*) AS count
       FROM applications
       WHERE company_id = $1
       GROUP BY current_stage`, [companyId]);
        ...
        const recruitersResult = await db_1.default.query(`SELECT COUNT(*) AS count FROM users WHERE company_id = $1 AND is_active = TRUE`, [companyId]);
 ...
 */
async function getRecentRecruitmentActivity(req, res) {
    try {
        const companyId = req.user.companyId;
...
//# sourceMappingURL=recruitment.dashboard.controller.js.map