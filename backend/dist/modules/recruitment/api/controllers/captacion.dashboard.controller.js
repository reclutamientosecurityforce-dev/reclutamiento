...
exports.getCaptacionSummary = getCaptacionSummary;
exports.getCaptacionFunnel = getCaptacionFunnel;
exports.getCategoryStats = getCategoryStats;
exports.getTopOpeningsCaptacion = getTopOpeningsCaptacion;
const db_1 = __importDefault(require("../../../../db"));
/**
 * GET /api/recruitment/captacion/summary
 * Métricas consolidadas del Centro de Captación
 */
async function getCaptacionSummary(req, res) {
    try {
 ...
 */
async function getCaptacionFunnel(req, res) {
    try {
        const companyId = req.user.companyId;
 ...
 */
async function getTopOpeningsCaptacion(req, res) {
    try {
        const companyId = req.user.companyId;
        const query = `
      SELECT 
...
//# sourceMappingURL=captacion.dashboard.controller.js.map