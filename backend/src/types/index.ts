...
export type DocumentCategory = 
  | 'IDENTIDAD'
  | 'FORMACION_ACADEMICA' // PostgreSQL ENUM usa sin tilde
  | 'EXPERIENCIA_LABORAL'
  | 'SEGURIDAD'
  | 'LICENCIAS'
  | 'CAPACITACION' // PostgreSQL ENUM usa sin tilde
  | 'OTROS';
...
export interface ApplicationDocument {
  ...
  uploaded_at: string;
  // Nuevos campos para expediente digital
  document_category?: DocumentCategory;
