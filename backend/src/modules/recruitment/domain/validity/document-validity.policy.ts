...
export interface ValidityEvaluationResult {
  ...
  normalizedExpiryDate: string | null; // YYYY-MM-DD
  notes: string;
}

export class DocumentValidityPolicy {
  public static readonly TIMEZONE = 'America/Lima';
   ...
   */
  public static getNowLima(referenceDate?: Date): Date {
   ...
   */
  public static parseEndOfDayLima(dateInput?: string | Date | null): Date | null {
   ...
   */
  public static evaluateValidity(
    expiresAtInput?: string | Date | null,
    options?: {
      referenceDate?: Date;
